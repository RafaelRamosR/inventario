<div class="container mt-5 mb-5" style="max-width:700px">
  <div class="card">
    <div class="card-header text-center">Reporte de sexos</div>
    <div class="card-body">
      <form method="post" target="_blank" action="?modulo=sexo&accion=descarga">

        <div class="form-group row">
          <label for="sexo" class="col-sm-4 col-form-label">Nombre sexo</label>
          <div class="col-sm-8">
            <input type="text" name="sexo" class="form-control form-control-sm" />
          </div>
        </div>
        <!-- Tipo de formato -->
        <div class="form-group row">
