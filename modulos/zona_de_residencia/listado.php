...
$sql .= " ORDER BY id_zona_de_residencia LIMIT $inicio, $num_registros  ";
?>
<table class="table table-striped" align="center">
    <thead>
        <tr>
            <th>No</th>
            <th>Nombre zona residencia</th>
            <th>Acciones</th>
        </tr>
    </thead>
    <tbody>
...
while ($row = mysqli_fetch_assoc($rs)) {
    ...
    echo "<td class='acciones'>
            ...
            <a href='javascript:;' class='eliminar' onclick='eliminar(\"$row[id_zona_de_residencia]\")'>
                <i class='fa fa-trash'></i>
            </a>
            <a href='javascript:;' class='modificar' onclick='modificar(\"$row[id_zona_de_residencia]\")'>
