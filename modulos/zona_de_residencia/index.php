...
?>
    ...
    <div id="contenedor-formulario" class="container mt-5" style="max-width:700px; display:none">
        <div class="card">
            ...
            <div class="card-header">
                <span id="titulo"><strong>zona de residencia</strong></span>
            </div>
...
<!-- FIN DEL FORMULARIO -->
    ...
    <br><br><br><br><br>
        ...
        function mostrar(id_zona_de_residencia) {
            var parametros = "id_zona_de_residencia=" + id_zona_de_residencia;
            $.get("?modulo=zona_de_residencia&accion=datos", parametros, function(respuesta) {
                $("#formulario")[0].reset(); //limpiar formulario
                ...
                $("#id_zona_de_residencia").prop("disabled", false);
        ...
        function eliminar(id_zona_de_residencia) {
        ...
        function modificar(id_zona_de_residencia) {
            var parametros = "id_zona_de_residencia=" + id_zona_de_residencia;
            $.get("?modulo=zona_de_residencia&accion=datos", parametros, function(respuesta) {
                $("#formulario")[0].reset(); //limpiar formulario
                $("#contenedor-listado").hide(); //ocultar
