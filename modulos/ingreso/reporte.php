<div class="container mt-5 mb-5" style="max-width:700px">
  <div class="card">
    <div class="card-header text-center">Reporte de ingresos</div>
    <div class="card-body">
      <form method="post" target="_blank" action="?modulo=ingreso&accion=descarga">

        <div class="form-group row">
          <label for="nombre" class="col-sm-4 col-form-label">Producto</label>
          <div class="col-sm-8">
        ...
        <div class="form-group row">
          <label for="fecha" class="col-sm-4 col-form-label">Fecha adquisición</label>
          <div class="col-sm-8">
