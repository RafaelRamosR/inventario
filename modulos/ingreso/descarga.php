...
if (isset($_POST['fecha']) == true &&  $_POST['fecha']  != "") {
    $filtros .= " AND e.fecha_ingreso = '$_POST[fecha]' ";
}
...
<table>
    <thead>
        <tr style="font-weight: bold; background-color: #ddd;">
            ...
            <th style="width: 150pt;">Producto</th>
            <th style="width: 150pt;">Fecha adquisición</th>
        </tr>
    </thead>
    <tbody>
        <?php
        ...
        ?>
            <tr style="background-color: <?php echo $color ?>;">
                ...
                <td style="width: 150pt;"><?php echo $row['fecha_ingreso'] ?></td>
            </tr>
        <?php
        }
        ?>
