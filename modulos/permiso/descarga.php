...
if (isset($_POST['permiso']) == true &&  $_POST['permiso']  != "") {
    $permiso = $_POST['permiso'];
    $permiso = str_replace(" ", "%", $permiso);
    $filtros .= " AND e.nombre LIKE '%$permiso%' ";
}

if (isset($_POST['descripcion']) == true &&  $_POST['descripcion']  != "") {
...
<table>
  <thead>
    <tr style="font-weight: bold; background-color: #ddd;">
      ...
      <th style="width: 150pt;">Tipo permiso</th>
      <th style="width: 150pt;">Descripción</th>
    </tr>
  </thead>
  <tbody>
    <?php
    ...
    ?>
      <tr style="background-color: <?php echo $color ?>;">
        ...
        <td style="width: 150pt;"><?php echo $row['descripcion'] ?></td>
      </tr>
    <?php
    }
    ?>
