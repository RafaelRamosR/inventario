<div class="container mt-5 mb-5" style="max-width:700px">
  <div class="card">
    ...
    <div class="card-body">
      <form method="post" target="_blank" action="?modulo=permiso&accion=descarga">

      <div class="form-group row">
          <label for="permiso" class="col-sm-4 col-form-label">Tipo permiso</label>
          <div class="col-sm-8">
            <input type="text" name="permiso" class="form-control form-control-sm" />
          </div>
        </div>
