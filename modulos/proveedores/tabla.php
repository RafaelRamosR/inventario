    ...
    <table class="table table-striped">
        <thead>
            ...
            <tr id="tr-filtros" class="<?php echo $filtros != '' ?  '' : 'd-none' ?>  ">
                ...
                <th scope="col">
                    <input type="text" name="direccion" class="form-control form-control-sm" value="<?php echo isset($_GET['direccion']) ? $_GET['direccion'] : ""  ?>" />
                </th>
                <th scope="col">
                    <input type="text" name="correo" class="form-control form-control-sm" value="<?php echo isset($_GET['correo']) ? $_GET['correo'] : ""  ?>" />
                </th>
