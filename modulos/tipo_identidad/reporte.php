<div class="container mt-5 mb-5" style="max-width:700px">
  <div class="card">
    <div class="card-header text-center">Reporte de tipo identidad</div>
    <div class="card-body">
      <form method="post" target="_blank" action="?modulo=tipo_identidad&accion=descarga">

        <div class="form-group row">
          <label for="nombre" class="col-sm-4 col-form-label">Tipo identidad</label>
          <div class="col-sm-8">
