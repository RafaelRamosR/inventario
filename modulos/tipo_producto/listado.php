...
while ($row = mysqli_fetch_assoc($rs)) {
    ...
    echo "<td class='acciones'>
            ...
            <a href='javascript:;' class='eliminar' onclick='eliminar(\"$row[id_tipo_producto]\")'>
                <i class='fa fa-trash'></i>
            </a>
            <a href='javascript:;' class='modificar' onclick='modificar(\"$row[id_tipo_producto]\")'>
