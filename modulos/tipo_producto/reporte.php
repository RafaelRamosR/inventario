<div class="container mt-5 mb-5" style="max-width:700px">
  <div class="card">
    <div class="card-header text-center">Reporte de tipo producto</div>
    <div class="card-body">
      <form method="post" target="_blank" action="?modulo=tipo_producto&accion=descarga">

        <div class="form-group row">
          <label for="nombre" class="col-sm-4 col-form-label">Tipo producto</label>
          <div class="col-sm-8">
