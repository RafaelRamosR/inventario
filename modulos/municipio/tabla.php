...
if (isset($_GET['departamento']) == true &&  $_GET['departamento']  != "") {
    ...
    <table class="table table-striped">
        <thead>
            ...
            <tr id="tr-filtros" class="<?php echo $filtros != '' ?  '' : 'd-none' ?>  ">
                ...
                <th scope="col">
                    <input type="text" name="departamento" class="form-control form-control-sm" value="<?php echo isset($_GET['departamento']) ? $_GET['departamento'] : ""  ?>" />
                </th>
